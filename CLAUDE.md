...
- Detalle fino de la etapa actual: `HANDOFF_claude_code.md` (ignorado por git), `HANDOFF_LAMINAS_A3.md`, `HANDOFF_VIDEO_CEPREB.md` (infografía A3 + video del mapa, sesión 10-13/09/2026) y `HANDOFF_GAS_OIL.md` (página `/gas-oil`, sesión 16/09/2026: estado, datos, decisiones de cálculo, pendientes y método de revisión por video).
