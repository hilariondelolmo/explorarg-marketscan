...
import {
  lon_min, kx, ky, MERC_TOP, VB_W, proyectar, kmAUnidades,
  ULTIMO_MES_CAP, BIO_OPERANDO, BIO_SIN_OPERAR, PLANTAS_ACEITE, REFINERIAS, METANOL,
  CATEGORIA_LABEL, lugar, nombreGrupo,
  encuadre, encuadreCaja, encuadreApertura, encuadrePunto,
  distanciaKm, RADIOS_KM, RUTAS, RUTAS_ACEITE, horas,
  RENDIMIENTO_ACEITE, DIAS_OPERACION, veces, capacidadAnual, CAP_ANUAL_MAX, simbolo,
} from '../../lib/plantas.js';
import '../charts/Chart.css';
import './Mercado.css';

// Datos, proyección y geometría viven en src/lib/plantas.js (compartidos
// con la infografía). Acá queda lo propio del mapa interactivo.
